...
class CreateAdminUser(Resource):
    ...
    def post(self):
        ...
        data = request.json
        required_fields = ["username", "email", "phone_number", "names", "gender", "national_id", "city", "address", "dob"]
        ...
        if not national_id.isdigit() or len(national_id) != 16:
            abort(400, message="Invalid 'Nation ID': must be exactly 16 numeric characters.")
